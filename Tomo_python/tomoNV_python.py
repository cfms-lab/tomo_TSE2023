...
#==================================================================================================
# Python versoion TomoNV main class definition
...
class tomoNV:
  ...
  def Pixelize_Step1(self):# Step 1. rotate and move onto bottom plate
    ...
    # self.R     = self.mesh0.get_rotation_matrix_from_xyz(( self.yaw, self.pitch, self.roll))
    # self.mesh1.rotate( self.R, center=(0,0,0))
    # (self.mesh1_min, self.mesh1_max,_) = getBoundary( self.mesh1.vertices)
    # self.mesh1.translate( np.asarray(self.mesh1_min) * -1.)

    # mat4x4 = getRotationMatrix( self.yaw, self.pitch, self.roll)
    # self.mesh1.transform(mat4x4)
    # (self.mesh1_min, _, _) = getBoundary( self.mesh1.vertices)
    # self.mesh1.translate( np.asarray(self.mesh1_min) * -1.)
    ...
    # self.mesh1.compute_triangle_normals() Caution: this gives wrong normal.
